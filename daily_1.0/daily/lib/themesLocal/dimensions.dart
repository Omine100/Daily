...
extension CustomWebDimensions on VisualDensity {
  ...
  // #region base
  double get baseWebProfileWidth => 1.0;
  double get baseWebProfileIconHeight => 0.11;
  double get baseWebProfileIconWidth => 0.11;
  double get baseWebProfileInfoWidth => 0.15;
  // #endregion
}
