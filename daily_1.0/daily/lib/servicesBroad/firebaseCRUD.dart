...
class FirebaseCRUD {
  ...
  Future<void> createImageData(BuildContext context, String fileName, File imageFile) async {
    ...
    try {
      ...
      InterfaceStandards().showToastMessage(context, "errorImageFailedToUpload");
    }
  }
  ...
  Future<void> updateImageData(BuildContext context, String imageURL, File imageFile) async {
    try {
